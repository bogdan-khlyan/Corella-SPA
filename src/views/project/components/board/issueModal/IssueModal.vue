...
import IssueView from '@/views/project/components/board/issueModal/components/View'
import Edit from '@/views/project/components/board/issueModal/components/Edit'
